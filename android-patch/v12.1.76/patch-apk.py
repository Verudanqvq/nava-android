...
if b'12.1.76' not in manifest and '12.1.76'.encode('utf-16le') not in manifest:
    raise ValueError('manifest 76 marker missing')
if '#nava-app-bottom' not in stylesheet or '#nava-app-topbar' in stylesheet:
    raise ValueError('bottom-only stylesheet validation failed')
...
print('PATCH_76_OK base=12.1.73 bottom-navigation-only=ok versionCode=92')
