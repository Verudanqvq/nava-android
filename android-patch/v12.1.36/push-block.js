/* Nava v12.1.36 — notification repair push registration. */
;(function(d,w){
  'use strict';
  if(w.__navaAndroidPushV12136)return;
  w.__navaAndroidPushV12136=true;
  ...
  function registerNow(){
    ...
    ref.set({uid:uid,token:token,platform:'android',appVersion:'12.1.36',deviceKey:deviceKey,notificationProtocol:'v4',notificationChannel:'nava_follower_releases_v3',updatedAt:stamp},{merge:true}).then(function(){
      try{localStorage.setItem('nava_push_registered_v12136:'+uid,'1')}catch(_){}
