/* Nava v12.1.41 — direct native FCM registration. */
;(function(d,w){
  'use strict';
  if(w.__navaAndroidPushV12141)return;
  w.__navaAndroidPushV12141=true;
  ...
  function registerNow(){
    ...
    ref.set({uid:uid,token:token,platform:'android',appVersion:'12.1.41',deviceKey:deviceKey,notificationProtocol:'direct-native-v5',notificationChannel:'nava_follower_releases_v4',updatedAt:stamp},{merge:true}).then(function(){
      try{localStorage.setItem('nava_push_registered_v12141:'+uid,'1')}catch(_){}
